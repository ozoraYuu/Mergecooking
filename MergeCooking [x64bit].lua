...
clear()
wait()
valueFromClass("BaseData3VO", "0x14", false, false, gg.TYPE_DWORD)
x="1003" t=d refine() 
        o=0x4 t=d offset() x="1~5000000" refine()
    ...
    if ck==off then
        ...
        gg.sleep(1000)
        gg.toast("Feature √On√")
        gg.alert("Claim Diamond In Star Chest")
gg.toast("~Complete~")
    else
        gg.setValues(x1)
        ck=off
...
o=0x4 t=d offset() x="1~5000000" refine()
    ...
    if ex==off then
        ...
        gg.sleep(1000)
        gg.toast("Feature √On√")
        gg.alert("Claim Exp In Stage Play Or Task")
        gg.toast("~Complete~")
    else
        gg.setValues(x5)
        ex=off
...
o=0x4 t=d offset() x="1~5000000" refine()
        ...
        x8=gg.getResults(gg.getResultsCount())
        clear() ST=1
    end 
    if st==off then
        ...
        gg.sleep(1000)
        gg.toast("Feature √On√")
        gg.alert("Claim Stamina In Stage Play Or Task")
        gg.toast("~Complete~")
    else
        gg.setValues(x7)
        st=off
...
o=0x4 t=d offset() x="1~5000000" refine()
        check() if E==0 then error() return end
        x9=gg.getResults(gg.getResultsCount())
        x10=gg.getResults(gg.getResultsCount())
        clear() BO=1
    end 
    if bo==off then
        ...
        gg.sleep(1000)
        gg.toast("Feature √On√")
        gg.alert("Claim Cooking Boost In Star Chest")
        gg.toast("~Complete~")
    else
        gg.setValues(x9)
        bo=off
